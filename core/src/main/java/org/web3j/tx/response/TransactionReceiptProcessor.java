...
public abstract class TransactionReceiptProcessor {
    ...
    public abstract Pair<? extends TransactionReceipt, Optional<Response.Error>> waitForTransactionReceiptResponse(String transactionHash) throws IOException, TimeoutException, InterruptedException;
