...
public class PollingTransactionReceiptProcessor extends TransactionReceiptProcessor {
    ...
    @Override
    public Pair<? extends TransactionReceipt, Optional<Response.Error>> waitForTransactionReceiptResponse(String transactionHash) throws IOException, TransactionException, InterruptedException {
        int i=0;
    ...
    public TransactionReceipt waitForTransactionReceipt(String transactionHash)
        ...
        Pair<? extends TransactionReceipt, Optional<Response.Error>> optionalPair = waitForTransactionReceiptResponse(transactionHash);
