...
/**
 * This class instance is returned after a successful submission of transaction.
 * It contains the transactionHash of the transaction and {@link #waitForReceipt()}
 * can be called to get full detail of the transaction after it appears in a block.
 */
public class EthTransactionReceiptInteraction implements RemoteCall<TransactionReceipt> {
    ...
    public EthTransactionReceiptInteraction(BigInteger gasLimit,EthSendTransaction ethSendTransaction, TransactionReceiptProcessor transactionReceiptProcessor) {
