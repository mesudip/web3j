...
public class ERC721 extends Contract {
    ...
    public EthTransactionInteraction approve(String _approved, BigInteger _tokenId, BigInteger weiValue) {
    ...
    public EthTransactionInteraction transferFrom(String _from, String _to, BigInteger _tokenId, BigInteger weiValue) {
        final Function function = new Function(
                FUNC_TRANSFERFROM, 
    ...
    public EthTransactionInteraction safeTransferFrom(String _from, String _to, BigInteger _tokenId, BigInteger weiValue) {
        final Function function = new Function(
    ...
    public EthTransactionInteraction setApprovalForAll(String _operator, Boolean _approved) {
        final Function function = new Function(
    ...
    public EthTransactionInteraction safeTransferFrom(String _from, String _to, BigInteger _tokenId, byte[] data, BigInteger weiValue) {
        final Function function = new Function(
                FUNC_SAFETRANSFERFROM, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(_from), 
                new org.web3j.abi.datatypes.Address(_to), 
